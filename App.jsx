...
class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div style={{ padding:40, textAlign:"center", color:C.r, fontFamily:C.mono }}>
          ...
          <button
            ...
            style={{ padding:"8px 20px", borderRadius:8, border:"1px solid "+C.r,
    ...
    <div style={{ background:C.bg, minHeight:"100vh", color:C.tx, fontFamily:C.sans }}>
      ...
      <div style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:12 }}>
          <span style={{ fontSize:16, fontWeight:700, color:C.w, fontFamily:C.sans, letterSpacing:1 }}>RB</span>
          <span style={{ fontSize:11, color:C.t2, fontFamily:C.mono }}>PRODUCTORA</span>
        </div>
